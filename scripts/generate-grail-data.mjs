...
const PROP_LABELS_ZH_TW = {
  str: '力量', dex: '敏捷', vit: '體能', enr: '能量',
  hp: '生命', mana: '法力', stam: '精力上限',
  ac: '防禦', 'ac%': '防禦強化 %', 'ac-miss': '對遠程防禦',
  'ac-hth': '對近戰防禦',
  'ac/lvl': '每等級防禦力', 'ignore-ac': '無視目標防禦',
  'dmg-ac': '傷害降低目標防禦力', 'reduce-ac': '目標防禦 %',
  'dmg%': '傷害強化 %', 'dmg-min': '最小傷害', 'dmg-max': '最大傷害',
  'dmg-norm': '傷害', 'dmg-fire': '火焰傷害', 'dmg-cold': '冰寒傷害',
  'dmg-ltng': '電擊傷害', 'dmg-pois': '毒素傷害', 'dmg-undead': '對不死怪物的傷害',
  'dmg-demon': '對惡魔的傷害',
  att: '準確率', 'att%': '準確率加成 %',
  'att-undead': '對不死怪物的準確率', 'att-demon': '對惡魔的準確率',
  crush: '機率造成粉碎打擊 %', deadly: '致命打擊 %', openwounds: '機率造成開放傷口 %',
  thorns: '攻擊者反傷', ease: '需求 %',
  'res-fire': '火焰抗性 %', 'res-cold': '冰寒抗性 %', 'res-ltng': '電擊抗性 %',
  'res-pois': '毒素抗性 %', 'res-all': '全抗性', 'res-mag': '魔法抗性 %',
  'res-fire-max': '最大火焰抗性 %', 'res-cold-max': '最大冷凍抗性 %',
  'res-ltng-max': '最大閃電抗性 %', 'res-pois-max': '最大毒素抗性 %',
  'res-pois-len': '中毒的時效縮短 %',
  'red-dmg': '傷害降低', 'red-dmg%': '受到的物理傷害降低 %', 'red-mag': '魔法傷害降低',
  lifesteal: '生命竊取 %', manasteal: '魔力竊取 %',
  regen: '生命回復', 'regen-mana': '法力恢復 %', 'regen-stam': '精力恢復 %',
  'mana-kill': '擊殺法力恢復', 'demon-heal': '擊殺惡魔生命恢復', noheal: '防止怪物自療',
  block: '格擋機率提高 %', block2: '格擋速度',
  balance1: '打擊恢復', balance2: '打擊恢復', balance3: '打擊恢復',
  swing1: '攻擊速度', swing2: '攻擊速度', swing3: '攻擊速度',
  cast1: '施法速度', cast2: '施法速度', cast3: '施法速度',
  move1: '跑步 / 行走速度 %', move2: '跑步 / 行走速度 %', move3: '跑步 / 行走速度 %',
  stamdrain: '精力消耗減緩 %',
  'pierce-fire': '敵人火焰抗性 %', 'pierce-ltng': '敵人電擊抗性 %',
  'pierce-cold': '敵人冰寒抗性 %', 'pierce-pois': '敵人毒素抗性 %', 'pierce-mag': '敵人魔法抗性 %',
  'extra-cold': '冰寒技能傷害 %', 'extra-fire': '火焰技能傷害 %',
  ...
  light: '照亮範圍', 'half-freeze': '被凍結的時效減半',
  freeze: '凍結目標', nofreeze: '無法凍結',
  howl: '機率擊中使怪物逃跑 %', stupidity: '擊中使目標目盲',
  'abs-ltng': '電擊吸收',
  slow: '使目標減慢 %', sock: '插槽數', dur: '耐久度 %', indestruct: '永不毀損',
  skill: '技能加成', oskill: '技能加成', skilltab: '技能列加成', allskills: '所有技能',
  'hit-skill': '攻擊時觸發機率', 'gethit-skill': '受擊時觸發機率',
  'death-skill': '死亡時觸發機率 %', 'levelup-skill': '升級時觸發機率 %',
  charged: '充能次數', 'mag%': '尋獲魔法物品機率提高 %', 'gold%': '怪物金幣掉落量提高 %',
  'dmg-to-mana': '受到的傷害轉為法力',
  dmg: '最大傷害', knock: '擊退',
  'abs-cold': '冰寒吸收', 'abs-fire': '火焰吸收',
  'rep-quant': '回復數量', 'rep-dur': '修復耐久度', stack: '堆疊數量提高',
  ama: '亞馬遜技能等級', ass: '刺客技能等級', bar: '蠻族技能等級',
  dru: '德魯伊技能等級', nec: '死靈法師技能等級', pal: '聖騎士技能等級',
  sor: '女巫技能等級', war: '術士技能等級', 'mana%': '法力上限提高 %', 'hp%': '生命上限提高 %',
  'ltng-min': '電擊傷害最小值', 'ltng-max': '電擊傷害最大值',
  'fire-min': '火焰傷害最小值', 'fire-max': '火焰傷害最大值',
  'cold-min': '冰寒傷害最小值', 'cold-max': '冰寒傷害最大值', 'cold-len': '冷凍持續時間',
  'pois-min': '毒素傷害最小值', 'pois-max': '毒素傷害最大值', 'pois-len': '毒素持續時間',
  pierce: '穿透攻擊 %',
  'pierce-immunity-cold': '破除怪物的冰寒免疫',
  'pierce-immunity-fire': '破除怪物的火焰免疫',
  'pierce-immunity-light': '破除怪物的閃電免疫',
  'pierce-immunity-poison': '破除怪物的毒素免疫',
  'pierce-immunity-damage': '破除怪物的物理免疫',
  'pierce-immunity-magic': '破除怪物的魔法免疫',
  'abs-ltng%': '電擊吸收 %', 'abs-cold%': '冰寒吸收 %', 'abs-fire%': '火焰吸收 %',
  'abs-mag': '魔法吸收',
  'res-all-max': '最大全抗性 %',
  'light-thorns': '攻擊者受到電擊傷害',
  block3: '格擋速度',
  magicarrow: '射出魔法箭矢', explosivearrow: '射出爆炸的弓矢或弩箭',
  'heal-kill': '擊殺生命恢復',
  'dmg-mag': '魔法傷害',
  'dmg-elem': '隨機元素傷害',
  fireskill: '火焰技能',
  ...
  rip: '殺死的怪物就此安息',
  reanimate: '復活成怪物機率 %',
  'charge-noconsume': '機率使終結技不消耗集氣的力量 %',
  'all-stats': '全部屬性',
  addxp: '獲得的經驗值 %',
...
const RUNEWORD_STAT_OVERRIDES = {
  ...
  'Voice of Reason': [
    rwStat('hit-skill', 15, 13, 'Frozen Orb'),
    rwStat('hit-skill', 18, 20, 'Ice Blast'),
    rwStat('att', 50, 50),
    rwStat('dmg-demon', 220, 350),
    rwStat('dmg-undead', 355, 375),
    rwStat('att-und', 50, 50),
    rwStat('dmg-cold', 100, 220),
    rwStat('pierce-cold', -24, -24),
    rwStat('dex', 10, 10),
    rwStat('nofreeze', 1, 1),
    rwStat('gold%', 75, 75),
    rwStat('light', 1, 1),
  ...
  Void: [
    rwStat('allskills', 2, 2),
    rwStat('cast2', 40, 40),
    rwStat('extra-mag', 10, 15),
    rwStat('oskill', 1, 3, 'Abyss'),
    rwStat('all-stats', 8, 12),
    rwStat('dmg-cold', 3, 14),
    rwStat('indestruct', 1, 1),
    rwStat('mag%', 30, 30),
    rwStat('charged', 35, 4, 'Decrepify'),
  ],
  Wealth: [
    rwStat('gold%', 250, 250),
    rwStat('mag%', 100, 100),
  ...
  Venom: [
    ...
    rwStat('ignore-ac', 1, 1),
    rwStat('manasteal', 7, 7),
    rwStat('charged', 27, 15, 'Poison Explosion'),
    rwStat('charged', 11, 13, 'Poison Nova'),
    { key: 'pois-dot', label: poisonDamageOverTimeLabel(6), min: 273, max: 273, isSkillRef: false },
  ],
  Vigilance: [
    rwStat('gethit-skill', 5, 10, 'Ring of Fire'),
    rwStat('move2', 10, 10),
    rwStat('block2', 30, 30),
    rwStat('ac%', 75, 100),
    rwStat('hp', 20, 40),
  ...
  Zephyr: [
    ...
    rwStat('move2', 25, 25),
    rwStat('swing2', 25, 25),
    rwStat('gethit-skill', 7, 1, 'Twister'),
  ],
  Wisdom: [
    rwStat('pierce', 33, 33),
    rwStat('att%', 15, 25),
    rwStat('manasteal', 4, 8),
    rwStat('ac%', 30, 30),
    rwStat('enr', 10, 10),
    rwStat('stamdrain', -15, -15),
    rwStat('nofreeze', 1, 1),
    rwStat('mana-kill', 5, 5),
    rwStat('dmg-to-mana', 15, 15),
  ],
  Wrath: [
    rwStat('hit-skill', 30, 1, 'Decrepify'),
    rwStat('hit-skill', 5, 10, 'Life Tap'),
    rwStat('dmg-demon', 300, 300),
    rwStat('att-demon', 100, 100),
    rwStat('dmg-undead', 250, 300),
    rwStat('dmg-mag', 85, 120),
    rwStat('dmg-ltng', 41, 240),
    rwStat('crush', 20, 20),
    rwStat('noheal', 1, 1),
    rwStat('enr', 10, 10),
    rwStat('nofreeze', 1, 1),
  ...
  White: [
    rwStat('howl', 25, 25),
    rwStat('vit', 10, 10),
    rwStat('skilltab', 3, 3, 7),
    rwStat('skill', 3, 3, 'Bone Armor'),
    rwStat('skill', 2, 2, 'Bone Spear'),
    rwStat('skill', 4, 4, 'Skeleton Mastery'),
    rwStat('red-mag', 4, 4),
    rwStat('cast2', 20, 20),
    rwStat('mana', 13, 13),
  ],
  Wind: [
    rwStat('hit-skill', 10, 9, 'Tornado'),
    rwStat('move2', 20, 20),
    rwStat('swing2', 40, 40),
    rwStat('balance2', 15, 15),
    rwStat('dmg%', 120, 160),
    rwStat('reduce-ac', 50, 50),
    rwStat('att', 50, 50),
    rwStat('stupidity', 1, 1),
    rwStat('light', 1, 1),
    rwStat('charged', 127, 13, 'Twister'),
  ],
  Treachery: [
    rwStat('gethit-skill', 5, 15, 'Fade'),
    rwStat('hit-skill', 25, 15, 'Venom'),
    rwStat('ass', 2, 2),
    rwStat('swing2', 45, 45),
    rwStat('balance2', 20, 20),
    rwStat('res-cold', 30, 30),
  ...
  'Unbending Will': [
    rwStat('hit-skill', 18, 18, 'Taunt'),
    rwStat('skilltab', 3, 3, 12),
    rwStat('swing2', 20, 30),
    rwStat('dmg%', 300, 350),
    rwStat('dmg-max', 9, 9),
    rwStat('att', 50, 50),
  ...
  Stone: [
    rwStat('balance2', 60, 60),
    rwStat('ac%', 250, 290),
    rwStat('ac-miss', 300, 300),
    rwStat('str', 16, 16),
    rwStat('vit', 16, 16),
    rwStat('enr', 10, 10),
    rwStat('res-all', 15, 15),
    rwStat('charged', 80, 16, 'Molten Boulder'),
    rwStat('charged', 16, 16, 'Clay Golem'),
  ],
  Strength: [
    rwStat('dmg%', 35, 35),
    rwStat('crush', 25, 25),
  ...
  Temper: [
    ...
    rwStat('vit', 10, 10),
    rwStat('hp%', 5, 5),
    rwStat('res-fire', 40, 60),
    rwStat('abs-fire%', 10, 15),
  ],
  Stealth: [
    rwStat('red-mag', 3, 3),
    rwStat('dex', 6, 6),
    rwStat('stam', 15, 15),
    rwStat('res-pois', 30, 30),
    rwStat('regen-mana', 15, 15),
    rwStat('move2', 25, 25),
    rwStat('cast2', 25, 25),
  ...
  Spirit: [
    rwStat('allskills', 2, 2),
    rwStat('cast3', 25, 35),
    rwStat('balance3', 55, 55),
    rwStat('vit', 22, 22),
    rwStat('ac-miss', 250, 250),
    rwStat('mana', 89, 112),
    rwStat('abs-mag', 3, 8),
    rwStatQualified(rwStat('res-ltng', 35, 35), 'Shields Only'),
    rwStatQualified(rwStat('thorns', 14, 14), 'Shields Only'),
    rwStatQualified(rwStat('res-cold', 35, 35), 'Shields Only'),
    rwStatQualified(rwStat('res-pois', 35, 35), 'Shields Only'),
    rwStatQualified(rwStat('dmg-ltng', 1, 50), 'Weapons Only'),
    rwStatQualified(rwStat('dmg-cold', 3, 14), 'Weapons Only'),
    rwStatQualified({ key: 'pois-dot', label: poisonDamageOverTimeLabel(5), min: 75, max: 75, isSkillRef: false }, 'Weapons Only'),
    rwStatQualified(rwStat('lifesteal', 7, 7), 'Weapons Only'),
  ],
  Splendor: [
