  ...
  return (
    <main className="flex flex-col items-center py-10 px-4 gap-6 flex-1 w-full">
      <div className="text-center">
        <h1 className="text-3xl font-bold tracking-tight text-parchment-bright">{t('levelUpPageTitle')}</h1>
        <p className="mt-2 text-sm text-muted max-w-md">{t('levelUpPageSubtitle')}</p>
      </div>
