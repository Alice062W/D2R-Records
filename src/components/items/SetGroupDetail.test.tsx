...
describe('SetGroupDetail', () => {
  it('renders every piece plus partial and full-set bonuses', () => {
    const piece: GrailItem = {
      ...
      defense: null, oneHandDamage: null, twoHandDamage: null, requiredStrength: 95, requiredDexterity: null, weaponSpeed: null, durability: 18, invFile: '',
  ...
  it('colors full-set bonuses by isSkillRef and variable/fixed status', () => {
    const piece: GrailItem = {
      ...
      defense: null, oneHandDamage: null, twoHandDamage: null, requiredStrength: null, requiredDexterity: null, weaponSpeed: null, durability: 50, invFile: '',
      stats: [], fixedStats: [], setBonuses: [], statPriority: [], note: null, statPools: [],
    };
    render(
      <NextIntlClientProvider locale="en" messages={messages}>
